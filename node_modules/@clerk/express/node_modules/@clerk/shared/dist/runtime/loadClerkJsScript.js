...
const require_versionSelector = require('./versionSelector-B4kFvqQU.js');
...
const clerkUIScriptUrl = (opts) => {
	...
	return `https://${buildScriptHost({
		...
		proxyUrl,
		domain
	})}/npm/@clerk/ui@${require_versionSelector.versionSelector(__internal_clerkUIVersion, "1.6.0")}/dist/ui.browser.js`;
};
